...
class LearningAgent(Agent):
    ...
    def __init__(self, env, learning=False, epsilon=1.0, alpha=0.6):
        ...
        self.trials = 0  # initially the number of trials is 0
    ...
    def reset(self, destination=None, testing=False):
        ...
        if testing == True:
            ...
            self.epsilon = float(1)/math.exp(float( a * self.trials))
...
def run():
    ...
    #myNamedArgs-Dileep = { 'learning':True, 'epsilon':1, 'alpha':0.5}
